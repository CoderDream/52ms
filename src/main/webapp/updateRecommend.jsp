...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*,com.coderdream.util.DBUtil,com.coderdream.dao.*,java.sql.*"%>
<html>
<head>
...
<script
	src="http://maps.google.com/maps?file=api&amp;
			...
			MAcBwfCDrkn8RTOtwnL4wJ4A6GZWdE82cQ6geLv4Q"
	type="text/javascript" charset="utf-8"></script>
<script
	src="http://www.google.com/jsapi?key=ABQIAAAA0DBHEJH01_0VN
...
<script type="text/javascript">
	...
	function check() {
		...
		myform1.action = "FileUploadServlet?action=insertMstxInfo&info_title=" + info_title + "&info_lon=" + info_lon + "&info_lat=" + info_lat + "&info_dis=" + info_dis
...
<body bgcolor="#ff7d00" onload="load()">
	...
	<table bgcolor="#ffffef" align="center" width="900px" border="0">
		<tr>
					...
					<tr>
						<td>
							<table align="center" width="100%">
								<tr align="center">
									<td><font size="6">上传美食</font></td>
								</tr>
								<tr align="center">
									<td><hr color="ffdeee" /></td>
								</tr>
							</table>
						</td>
					</tr>
						...
						<td>
							<form action="" name="myform2" method="get">
								<table align="center">
									<tr>
										<td>美食名称：</td>
										<td><input type="text" class=f2_input name="info_title">
										</td>
									</tr>
									<tr>
										<td>饭店名称:</td>
										<td><input type="text" class=f2_input name="info_hotel">
										</td>
									</tr>
									<tr>
										<td>种类：</td>
									...
									<tr>
										<td>价格：</td>
										<td><input type="text" class=f2_input name="info_price">
										</td>
									</tr>
									<tr>
										<td><input type="hidden" class=f2_input name="info_lon"
											disabled="disabled" id="info_lon">
										</td>
									</tr>
									<tr>
										<td><input type="hidden" class=f2_input name="info_lat"
											disabled="disabled" id="info_lat">
										</td>
									</tr>
									<tr>
										<td>美食描述：</td>
										<td><textarea rows="7" class=f2_input name="info_dis"
												cols="29"></textarea></td>
									</tr>
									<tr>
										<td></td>
						...
						<td>
							<form name="myform1" action="FileUploadServlet"
								...
								<table align="center">
									...
									<tr>
										<td><input type="submit" value="确定" class="btn">
										</td>
									</tr>
								</table>
							</form>
			...
			<td width="50%">
				<div id="map"
					style="height: 350px; width: 80%; border: solid 1px #000000;"></div>
			</td>
		</tr>
	</table>
