...
public class UserInfo {
	...
	public UserInfo(int uid, String uName, String uQq, String uEmail, String uDis, int uHead, boolean uAdmin,
			String uMood, int uIntegral, String uHobby, int uLevel, int uNumber) {
		super();
		this.uid = uid;
		u_name = uName;
		u_qq = uQq;
	...
	public String toString() {
		return "UserInfo [uid=" + uid + ", u_name=" + u_name + ", u_qq=" + u_qq + ", u_Email=" + u_Email + ", u_dis="
				+ u_dis + ", u_head=" + u_head + ", u_admin=" + u_admin + ", u_mood=" + u_mood + ", u_integral=" + u_integral
				+ ", u_hobby=" + u_hobby + ", u_level=" + u_level + ", u_number=" + u_number + "]";
	}
